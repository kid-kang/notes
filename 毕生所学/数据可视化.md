...
ECharts图的series中的data变了为啥视图还没变?

这是因为 ECharts 采用了异步渲染的方式，即视图渲染的过程是异步进行的。因此，在修改了数据后，需要手动调用 `setOption` 方法来更新视图。
...
常见的数据可视化库：官网地址：<https://www.echartsjs.com/zh/index.html>
...
> ECharts，底层依赖矢量图形库 [ZRender](https://github.com/ecomfe/zrender)，提供直观，交互丰富，可高度个性化定制的数据可视化图表。
